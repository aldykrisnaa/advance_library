...
@Composable
fun ItemBerandaNonFiksi(
    modifier: Modifier = Modifier,
    itemnonfiksi: ItemNonFiksi,
    ...
    Box(
        ...
        Column(
            modifier = modifier
                .clickable {
                    onItemClicked(itemnonfiksi.id)}
                .padding(16.dp),
            horizontalAlignment = Alignment.CenterHorizontally
        ) {
            Image(
                painter = painterResource(id =  itemnonfiksi.image),
                contentDescription = "",
                modifier = Modifier
                    .height(180.dp)
                    .width(150.dp)
...
private fun Preview() {
    AdvanceLibraryTheme {
        ItemBerandaNonFiksi(
            ...
            onItemClicked = { itemnonfiksiId ->
                println("Item Non Fiksi Id : $itemnonfiksiId")
            }
        )
    }
}
